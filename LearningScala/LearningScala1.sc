object LearningScala1 {
  ...
  val hello: String = "Hello, Scala!"             //> hello  : String = Hello, Scala!
  ...
  var helloThere: String = hello                  //> helloThere  : String = Hello, Scala!
  helloThere = hello + " There!"
  println(helloThere)                             //> Hello, Scala! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Hello, Scala!There!
  println(immutableHelloThere)                    //> Hello, Scala!There!
  ...
  val pix2 = pi * 2                               //> pix2  : Double = 6.2831853
  println(f"Pi is $pix2%.3f")                     //> Pi is 6,283
}